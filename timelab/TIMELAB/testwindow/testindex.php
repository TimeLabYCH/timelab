    ...
    <body>
            ...
            <div class="container">
                <div class="row page-heading">
                    ...
                    <div class="col-md-4 col-sm-4 hidden-xs page-icon-holder">
                      <p class="page-icon"><i class="fa fa-user"></i></p>                  <!-- 个人资料编辑按钮 -->
                    </div>
                </div>
                <div class="row">
        ...
        <section id="gallery" class="page-section">
            <div class="container">
                <div class="row page-heading">
                    <div class="col-md-8 col-sm-8">
                        <h3 class="page-title"><a href="#" >My Gallery</a></h3>
...
<!--                         <div class="fileInputContainer">  -->                                       <!-- 跳转出选择图片页面  有BUG-->
<!--                     <input class="fileInput" type="file" name="" id="" /></div>  -->                <!-- 跳转出选择图片页面  有BUG-->
                    <div class="fileInputContainer">
                    <input type="button" value="修改" class="btn" onclick="editUser(<?php echo $row['id']?>)"></div>
                   
                   <p class="page-icon">   <i class="fa fa-camera"></i></p></a>
                    </div>
                </div>
                <div class="row">
                    <div class="gallery-holder">
                        <div class="col-md-3 col-sm-6 col-xs-12 gallery-item">
                            <div class="gallery-thumb">
                                ...
                                <div class="hover">
                                    <a href="#" class="fa fa-plus"></a>                         <!-- gallery展示图片修改按钮 -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 gallery-item">
